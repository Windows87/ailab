...
CREATE TABLE IF NOT EXISTS `deeplab`.`topic_subtopics` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `subtopis_id` INT NOT NULL,
  `topic_id` INT NOT NULL,
  PRIMARY KEY (`id`, `subtopis_id`, `topic_id`),
  INDEX `fk_subtopics_has_topics_topics1_idx` (`topic_id` ASC),
  INDEX `fk_subtopics_has_topics_subtopics1_idx` (`subtopis_id` ASC),
  CONSTRAINT `fk_subtopics_has_topics_subtopics1`
    FOREIGN KEY (`subtopis_id`)
    REFERENCES `deeplab`.`subtopics` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
